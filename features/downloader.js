...
__path = process.cwd()
     ...
     async function tiktok(req, res) {
         try {
            ...
            limitAdd(apikey);
            let result = await TiktokDownloader(url)
     ...
     async function lovetik(req, res) {
     	try {
            let url = req.query.url
            let apikey = req.query.apikey
            if (!url) return res.status(400).send({ status: 400, message: 'url parameter cannot be empty', result: 'error' })
            ...
            if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
            limitAdd(apikey);
            let hasil = await api.downloader.tiktok(url)
            let title = await (hasil.title)
            let author = await (hasil.author)
            let nowm = await (hasil.nowm)
            let watermark = await (hasil.watermark)
            let audio = await (hasil.audio)
            let thumbnail = await (hasil.thumbnail)
             res.status(200).json({ status: 200, result: { title: title, author: author, nowm: nowm, watermark: watermark, audio: audio, thumbnail: thumbnail }})
         } catch(err) {
             console.log(err)
             res.status(500).send({ status: 500, message: 'An internal error occurred. Please report via WhatsApp wa.me/6285714627920', result: 'error' })
         }
     ...
     async function tiktokwm(req, res) {
         try {
            ...
            limitAdd(apikey);
            let hasil = await api.downloader.tiktok(url)
            let data = await getBuffer(hasil.watermark)
             await fs.writeFileSync(__path +'/tmp/tiktok.mp4', data)
             await res.sendFile(__path +'/tmp/tiktok.mp4')
         } catch(err) {
             console.log(err)
     ...
     async function savefrom(req, res) {
         try {
            ...
            if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
            limitAdd(apikey);
            let result = await tt.savefrom(url)
              res.status(200).json({ status: 200, result: result })
          } catch(err) {
              console.log(err)
              res.status(500).send({ status: 500, message: 'An internal error occurred. Please report via whatsApp wa.me/6285714627920', result: 'error' })
     ...
     async function spotifydl(req, res) {
         try {
            ...
            if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
            limitAdd(apikey);
            let result = await md.spotifydl(url)
              res.status(200).json({ status: 200, result: result })
          } catch(err) {
              console.log(err)
              res.status(500).send({ status: 500, message: 'An internal error occurred. Please report via whatsApp wa.me/6285714627920', result: 'error' })
     ...
     async function goredl(req, res) {
         try {
            ...
            if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
            limitAdd(apikey);
            let result = await ss.goredl(url)
     ...
     async function youtube(req, res) {
        try {
            ...
            let audioUrl = await shorts('https://kanza-api.herokuapp.com/api/toFile?url='+yt1.dl_link)
            let videoUrl = await shorts('https://kanza-api.herokuapp.com/api/toFile?url='+yt2.dl_link)
     ...
     async function youtube2(req, res) {
          try {
            ...
            if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
            limitAdd(apikey);
            let result = await md.youtube(url)
              res.status(200).json({ status: 200, result: result })
          } catch(err) {
              console.log(err)
              res.status(500).send({ status: 500, message: 'An internal error occurred. Please report via whatsapp wa.me/6285714627920', result: 'error' })
    ...
    async function ytplaymp3(req, res) {
     ...
     async function dddtik(req, res) {
         try {
            ...
            if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
            limitAdd(apikey);
            let result = await md.dddtik(url)
              res.status(200).json({ status: 200, result: result })
          } catch(err) {
              console.log(err)
              res.status(500).send({ status: 500, message: 'An internal error occurred. Please report via WhatsApp wa.me/6289503657396', result: 'error' })
     ...
     async function tiktokder(req, res) {
         try {
            ...
            if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
            limitAdd(apikey);
            let result = await md.tiktokder(url)
              res.status(200).json({ status: 200, result: result })
          } catch(err) {
              console.log(err)
              res.status(500).send({ status: 500, message: 'An internal error occurred. Please report via WhatsApp wa.me/6289503657396', result: 'error' })
     ...
     async function googledrive(req, res) {
         try {
            ...
            if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
            limitAdd(apikey);
            let result = await md.GDriveDl(url)
              res.status(200).json({ status: 200, result: result })
          } catch(err) {
              console.log(err)
              res.status(500).send({ status: 500, message: 'An internal error occurred. Please report via WhatsApp wa.me/6289503657396', result: 'error' })
