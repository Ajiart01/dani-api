...
__path = process.cwd()
     ...
     async function asupan(req, res) {
         ...
         let check = await cekKey(apikey)
         if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
         let video = JSON.parse(fs.readFileSync(__path +'/lib/asupan/asupan.json'))
     ...
     async function bocil(req, res) {
         ...
         let check = await cekKey(apikey)
         if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
         let video = JSON.parse(fs.readFileSync(__path +'/lib/asupan/bocil.json'))
         let result = video[Math.floor(Math.random() * (video.length))]
         let data = await getBuffer(result)
         let limit = await isLimit(apikey);
         if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
     ...
     async function geayubi(req, res) {
         ...
         let check = await cekKey(apikey)
         if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
         let video = JSON.parse(fs.readFileSync(__path +'/lib/asupan/geayubi.json'))
         let result = video[Math.floor(Math.random() * (video.length))]
         let data = await getBuffer(result)
         let limit = await isLimit(apikey);
         if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
     ...
     async function hijaber(req, res) {
         ...
         let check = await cekKey(apikey)
         if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
         let image = JSON.parse(fs.readFileSync(__path +'/lib/asupan/hijaber.json'))
     ...
     async function kayes2(req, res) {
         ...
         let check = await cekKey(apikey)
         if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
         let video = JSON.parse(fs.readFileSync(__path +'/lib/asupan/kayes.json'))
         let result = video[Math.floor(Math.random() * (video.length))]
         let data = await getBuffer(result)
         let limit = await isLimit(apikey);
         if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
     ...
     async function loliv(req, res) {
         ...
         let check = await cekKey(apikey)
         if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
         let video = JSON.parse(fs.readFileSync(__path +'/lib/asupan/loli.json'))
         let result = video[Math.floor(Math.random() * (video.length))]
         let data = await getBuffer(result)
         let limit = await isLimit(apikey);
         if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
     ...
     async function notnot2(req, res) {
         ...
         let check = await cekKey(apikey)
         if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
         let video = JSON.parse(fs.readFileSync(__path +'/lib/asupan/notnot.json'))
         let result = video[Math.floor(Math.random() * (video.length))]
         let data = await getBuffer(result)
         let limit = await isLimit(apikey);
         if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
     ...
     async function rikagusriani(req, res) {
         ...
         let check = await cekKey(apikey)
         if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
         let video = JSON.parse(fs.readFileSync(__path +'/lib/asupan/rikagusriani.json'))
         let result = video[Math.floor(Math.random() * (video.length))]
         let data = await getBuffer(result)
         let limit = await isLimit(apikey);
         if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
     ...
     async function ukhty(req, res) {
         ...
         let check = await cekKey(apikey)
         if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
         let video = JSON.parse(fs.readFileSync(__path +'/lib/asupan/ukhty.json'))
         let result = video[Math.floor(Math.random() * (video.length))]
         let data = await getBuffer(result)
         let limit = await isLimit(apikey);
         if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
     ...
     async function china(req, res) {
        ...
        let check = await cekKey(apikey)
        if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
        let video = JSON.parse(fs.readFileSync(__path +'/lib/cecan/china.json'))
        let result = video[Math.floor(Math.random() * (video.length))]
        let data = await getBuffer(result)
        let limit = await isLimit(apikey);
        if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
    ...
    async function indonesia(req, res) {
        ...
        let check = await cekKey(apikey)
        if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
        let video = JSON.parse(fs.readFileSync(__path +'/lib/cecan/indonesia.json'))
        let result = video[Math.floor(Math.random() * (video.length))]
        let data = await getBuffer(result)
        let limit = await isLimit(apikey);
        if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
    ...
    async function korea(req, res) {
        ...
        let check = await cekKey(apikey)
        if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
        let video = JSON.parse(fs.readFileSync(__path +'/lib/cecan/korea.json'))
        let result = video[Math.floor(Math.random() * (video.length))]
        let data = await getBuffer(result)
        let limit = await isLimit(apikey);
        if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
    ...
    async function japan(req, res) {
        ...
        let check = await cekKey(apikey)
        if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
        let video = JSON.parse(fs.readFileSync(__path +'/lib/cecan/japan.json'))
        let result = video[Math.floor(Math.random() * (video.length))]
        let data = await getBuffer(result)
        let limit = await isLimit(apikey);
        if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
    ...
    async function thailand(req, res) {
        ...
        let check = await cekKey(apikey)
        if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
        let video = JSON.parse(fs.readFileSync(__path +'/lib/cecan/thailand.json'))
        let result = video[Math.floor(Math.random() * (video.length))]
        let data = await getBuffer(result)
        let limit = await isLimit(apikey);
        if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
    ...
    async function vietnam(req, res) {
        ...
        let check = await cekKey(apikey)
        if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
        let video = JSON.parse(fs.readFileSync(__path +'/lib/cecan/vietnam.json'))
        let result = video[Math.floor(Math.random() * (video.length))]
        let data = await getBuffer(result)
        let limit = await isLimit(apikey);
        if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
    ...
    async function jeni(req, res) {
        ...
        let check = await cekKey(apikey)
        if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
        let video = JSON.parse(fs.readFileSync(__path +'/lib/cecan/jeni.json'))
        let result = video[Math.floor(Math.random() * (video.length))]
        let data = await getBuffer(result)
        let limit = await isLimit(apikey);
        if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
    ...
    async function jiso(req, res) {
        ...
        let check = await cekKey(apikey)
        if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
        let video = JSON.parse(fs.readFileSync(__path +'/lib/cecan/jiso.json'))
        let result = video[Math.floor(Math.random() * (video.length))]
        let data = await getBuffer(result)
        let limit = await isLimit(apikey);
        if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
    ...
    async function justina(req, res) {
        ...
        let check = await cekKey(apikey)
        if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
        let video = JSON.parse(fs.readFileSync(__path +'/lib/cecan/justina.json'))
        let result = video[Math.floor(Math.random() * (video.length))]
        let data = await getBuffer(result)
        let limit = await isLimit(apikey);
        if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
    ...
    async function rose(req, res) {
        ...
        let check = await cekKey(apikey)
        if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
        let video = JSON.parse(fs.readFileSync(__path +'/lib/cecan/rose.json'))
        let result = video[Math.floor(Math.random() * (video.length))]
        let data = await getBuffer(result)
        let limit = await isLimit(apikey);
        if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
    ...
    async function ryujin(req, res) {
        ...
        let check = await cekKey(apikey)
        if (!check) return res.status(404).send({ status: 404, message: `apikey ${apikey} not found, please register first.` })
        let video = JSON.parse(fs.readFileSync(__path +'/lib/cecan/ryujin.json'))
        let result = video[Math.floor(Math.random() * (video.length))]
        let data = await getBuffer(result)
        let limit = await isLimit(apikey);
        if (limit) return res.status(429).send({ status: 429, message: 'requests limit exceeded (100 req / day), call owner for an upgrade to premium', result: 'error' })
